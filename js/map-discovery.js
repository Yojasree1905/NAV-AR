...
const CAMPUS_SURVEYED_POIS = [
  ...
  {
    id: 'node/14168860238',
    name: 'J Block Lift Entrance',
    lat: 12.9680483,
    lon: 79.1590861,
    type: 'dormitory',
    purpose: 'Ladies Hostel J • Lift Entrance (for luggage)',
    tags: { building: 'dormitory', name: 'J Block lift' },
    aliases: ['hostel j', 'j hostel', 'ladies hostel j', 'block j', 'j block lift', 'lift entrance', 'luggage entrance'],
  },
  {
    id: 'node/14165878674',
    name: 'Hostel Gate',
